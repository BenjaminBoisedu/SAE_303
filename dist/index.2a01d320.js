...
(async function puzzles() {
    ...
    function construct(thirdElementData) {
        ...
        let sorted = [];
        // Check status
        if (thirdElementData[i].status == "SAT") for(let i = 0; i < times.length; i++){
            let solved = 0;
            for(let j = 0; j < thirdElementData.length; j++){
                if (thirdElementData[j].status == "SAT") {
                    if (thirdElementData[j].time == times[i]) solved++;
                }
            }
            sorted.push(solved);
        }
        ...
        new (0, _auto.Chart)(document.getElementById("dimensions"), {
            ...
            data: {
                ...
                datasets: [
                    {
                        label: "Nombre de puzzles r\xe9solus par temps ",
                        data: sorted,
                        barPercentage: 2,
                        backgroundColor: [
                            "rgba(255, 99, 132, 0.2)",
            ...
            options: {
                ...
                plugins: {
                    ...
                    title: {
                        display: true,
                        text: "Meilleur temps de r\xe9solution"
                    },
                    scales: {
                        xAxes: [
                            {
                                ...
                                scaleLabel: {
                                    display: true,
                                    labelString: "Nombre de puzzles r\xe9solus par temps"
                                }
                            }
                        ],
                        yAxes: [
                            {
                                display: true,
                                screenReaderLabel: "Nombre de puzzles r\xe9solus par temps",
                                ticks: {
                                    beginAtZero: true,
                                    steps: 10,
                                    stepValue: 5,
...
},{"chart.js/auto":"d8NN9"}]},["ioPng","7WR2a"], "7WR2a", "parcelRequire30ab")

...
})({"cUfAO":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "2ed39536e4e9283e";
"use strict";
...
},{}],"2EjeM":[function(require,module,exports) {
...
(async function puzzles() {
    ...
    function construct(thirdElementData) {
        let set = new Set(thirdElementData.map((row)=>row.name), thirdElementData.map((row)=>row.time));
        ...
        function average(name) {
            ...
            for(let i = 0; i < thirdElementData.length; i++){
                let solverName = name;
                if (thirdElementData[i].status == "SAT" && thirdElementData[i].name == solverName || thirdElementData[i].status == "UNSAT" && thirdElementData[i].name == solverName) {
        ...
        new (0, _auto.Chart)(document.getElementById("rank"), {
            type: "line",
            data: {
                labels: sortedNames,
                datasets: [
...
},{}]},["cUfAO","2EjeM"], "2EjeM", "parcelRequire30ab")

//# sourceMappingURL=index.e4e9283e.js.map
